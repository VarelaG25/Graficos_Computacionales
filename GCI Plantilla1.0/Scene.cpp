...
bool Scene::Initialize() {
	...
	Dragon = new GameObject(OpenGL, handlerWindow, LoaderTexture,
		"modelos/dragon1.obj", "modelos/dragon1.png", "modelos/dragon1n.png");
	if (!Dragon) {
		result = false;
		MessageBoxA(handlerWindow, "Could not initialize the GameObject.", "Error", MB_OK);
		_RPT1(0, "Alert! GameObject has an error on start. \n", 0);
...
bool Scene::Render() {
	...
	Torre->Render(viewMatrix, projectionMatrix, true);
	Dragon->Render(viewMatrix, projectionMatrix, true);
	Dragon2->Render(viewMatrix, projectionMatrix, true);
	Carreta->Render(viewMatrix, projectionMatrix, true);
	Pozo->Render(viewMatrix, projectionMatrix, true);
	Vaca->Render(viewMatrix, projectionMatrix, true);
	Vaca2->Render(viewMatrix, projectionMatrix, true);
	Vaca3->Render(viewMatrix, projectionMatrix, true);
	Vaca4->Render(viewMatrix, projectionMatrix, true);
	Vaca5->Render(viewMatrix, projectionMatrix, true);
	Vaca6->Render(viewMatrix, projectionMatrix, true);
	ArbolAhorcado->Render(viewMatrix, projectionMatrix, true);
	///////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool Scene::Update(InputClass* input, float deltaTime) {
	...
	OpenGL->MatrixScale(scaleMatrixCasa, 6.0f, 6.0f, 6.0f);
	...
	OpenGL->MatrixTranslation(matrixcasa2, -150.0f, Terreno->Superficie(-150.0f, -60.0f) - 2, -60.0f);
	OpenGL->MatrixScale(matrixcasa2, 3.0f, 3.0f, 3.0f);
	...
	OpenGL->MatrixTranslation(translationMatrix, 160.0f, Terreno->Superficie(160.0f, -160.0f) + 17, -160.0f); // Traslación
	...
	if (volar) {
		...
		OpenGL->MatrixTranslation(translationMatrix2, PosX, PosY, PosZ); // Traslación

		OpenGL->BuildIdentityMatrix(scaleMatrix2);
		OpenGL->MatrixScale(scaleMatrix2, 6.0f, 6.0f, 6.0f); // Escala
